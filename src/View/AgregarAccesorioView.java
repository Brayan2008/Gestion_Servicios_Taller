...
public class AgregarAccesorioView extends JDialog implements JViews {
    ...
    public AgregarAccesorioView(JFrame parent) {
        super(parent, "Accesorios");
    ...
    public void agregarComponentes() {
        ...
        JLabel nombre_label = new JLabel("Nombre del Accesorio:");
