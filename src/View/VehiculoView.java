...
public class VehiculoView extends JPanel implements JViews{

    public final VehiculoService vs = new VehiculoService();
    ...
    public static void main(String[] args) {
        JFrame prueba = new JFrame("Gestión de vehículos");
    ...
    public void agregarComponentes() {
        ...
        tablaVehiculos = new JTable(vs.listarVehiculos());
        tablaVehiculos.setGridColor(Colors.LIGHT_GRAY);
        tablaVehiculos.setRowHeight(23);
        tablaVehiculos.setRowMargin(5);
        tablaVehiculos.getTableHeader().setBackground(Colors.FONDO_1);
        tablaVehiculos.getTableHeader().setForeground(Color.WHITE);
        tablaVehiculos.getTableHeader().setFont(Colors.ButtonText1);
        ...
        tablaVehiculos.getColumnModel().getColumn(0).setCellRenderer(tb);
        tablaVehiculos.getColumnModel().getColumn(2).setCellRenderer(tb);
